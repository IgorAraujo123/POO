class Televisor:
    ...
    def view(self):
        print(f'Volume: {self.volume}, Canal: {self.canal_atual}, Canais Disponiveis: {self.lista_de_canais}')
...
class ControleRemoto:
    ...
    def aumenteVolume(self):
        self.tv.aumentaVolume(60)
    
    def diminuiVolume(self):
        self.tv.diminuiVolume(60)
